...
import a2_bi12480.kengine.Doc;
import a2_bi12480.kengine.DocCnt;
import a2_bi12480.kengine.Engine;
import a2_bi12480.kengine.Query;
...
public class ProgStudentMan {
  ...
  {
    try{
        Student new_student = new Student((int) data[0], (String) data[1], (String) data[2], (String) data[3]);
        return new_student;
    }
    catch (Exception e) {
        throw new NotPossibleException("Student.createStudent: invalid data");
    }
  }
  ...
  public UndergradStudent createUndergradStudent(Object[] data) throws NotPossibleException{
    try{
        UndergradStudent undergrad_student = new UndergradStudent((int) data[0], (String) data[1], (String) data[2], (String) data[3]);
        return undergrad_student;
    }
    catch (Exception e) {
        throw new NotPossibleException("Student.createUndergradStudent: invalid data");
    }
  }
  ...
  public PostgradStudent createPostgradStudent(Object[] data) throws NotPossibleException{
    try{
        PostgradStudent postgrad_student = new PostgradStudent((int) data[0], (String) data[1], (String) data[2], (String) data[3], (float) data[4]);
        return postgrad_student;
    }
    catch (Exception e) {
        throw new NotPossibleException("Student.createPostgradStudent: invalid data");
    }
  }
  ...
  public Query search(String[] words) throws NotPossibleException {
    if (words == null || words.length == 0) {
      throw new NotPossibleException("ProgStudentMan.search: no keywords");
    }
    try {
        ...
        throw new NotPossibleException("ProgStudentMan.search: invalid keywords");
    }
  }
}
